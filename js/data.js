...
(function () {
  ...
  const ARENAS = [
    ...
    { key: "ruins", name: "市街の廃墟", flavor: "遮蔽多・接近戦／側面取り有利", w: 100, h: 80, base: "plains",
      obstacles: [{ x: 30, y: 16, w: 10, h: 8 }, { x: 62, y: 52, w: 10, h: 9 }, { x: 48, y: 36, w: 6, h: 6 }],
      terrain: [{ x: 12, y: 28, w: 14, h: 18, t: "rubble" }, { x: 74, y: 34, w: 14, h: 18, t: "rubble" }],
