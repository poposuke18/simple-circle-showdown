...
(function () {
  ...
  const ARENAS = [
    { key: "plain", name: "開けた平原", flavor: "遮蔽ほぼ無し・長射程有利（近接は接近地獄）", w: 150, h: 110, base: "plains",
      obstacles: [{ x: 72, y: 50, w: 8, h: 8 }],
      terrain: [{ x: 32, y: 18, w: 22, h: 18, t: "forest" }, { x: 98, y: 70, w: 22, h: 18, t: "forest" }],
      start: { p: { x: 24, y: 55 }, c: { x: 126, y: 55 } } },
    { key: "ruins", name: "市街の廃墟", flavor: "瓦礫と建物が細かく入り組む・接近戦／側面取り有利", w: 100, h: 80, base: "plains",
      obstacles: [{ x: 20, y: 18, w: 8, h: 7 }, { x: 40, y: 12, w: 7, h: 6 }, { x: 58, y: 22, w: 7, h: 7 }, { x: 74, y: 16, w: 7, h: 6 }, { x: 30, y: 40, w: 6, h: 6 }, { x: 50, y: 46, w: 7, h: 7 }, { x: 66, y: 40, w: 6, h: 7 }, { x: 34, y: 62, w: 7, h: 6 }, { x: 56, y: 62, w: 7, h: 6 }],
      terrain: [{ x: 10, y: 30, w: 14, h: 18, t: "rubble" }, { x: 76, y: 54, w: 14, h: 18, t: "rubble" }],
      start: { p: { x: 8, y: 40 }, c: { x: 92, y: 40 } } },
    { key: "arena", name: "狭い闘技場", flavor: "狭くカイト不能・強制接近", w: 26, h: 22, base: "plains",
      obstacles: [{ x: 11, y: 9, w: 4, h: 4 }],
      terrain: [{ x: 9, y: 2, w: 6, h: 4, t: "highground" }],
      start: { p: { x: 3, y: 11 }, c: { x: 23, y: 11 } } },
    { key: "forest", name: "深い森", flavor: "全域が茂み・回避/防御高・遠距離弱体", w: 130, h: 100, base: "forest",
      obstacles: [{ x: 48, y: 26, w: 6, h: 6 }, { x: 76, y: 64, w: 6, h: 6 }],
      terrain: [{ x: 56, y: 44, w: 18, h: 14, t: "swamp" }],
      start: { p: { x: 12, y: 50 }, c: { x: 118, y: 50 } } },
    { key: "bunker", name: "中央遮蔽", flavor: "中央に大遮蔽・角度取りと回り込み", w: 120, h: 100, base: "plains",
      obstacles: [{ x: 52, y: 42, w: 16, h: 16 }],
      terrain: [{ x: 20, y: 38, w: 12, h: 14, t: "rubble" }, { x: 88, y: 38, w: 12, h: 14, t: "rubble" }, { x: 50, y: 8, w: 20, h: 8, t: "swamp" }, { x: 50, y: 84, w: 20, h: 8, t: "swamp" }],
      start: { p: { x: 10, y: 50 }, c: { x: 110, y: 50 } } },
    { key: "volcano", name: "溶岩洞窟", flavor: "溶岩が点在・立ち位置が命取り（押し込まれると焼かれる）", w: 100, h: 78, base: "plains",
      obstacles: [{ x: 32, y: 12, w: 8, h: 7 }, { x: 62, y: 58, w: 8, h: 7 }],
      terrain: [{ x: 44, y: 0, w: 12, h: 26, t: "lava" }, { x: 44, y: 52, w: 12, h: 26, t: "lava" }, { x: 22, y: 18, w: 10, h: 9, t: "lava" }, { x: 68, y: 46, w: 10, h: 9, t: "lava" }, { x: 12, y: 36, w: 8, h: 7, t: "rubble" }],
      start: { p: { x: 8, y: 39 }, c: { x: 92, y: 39 } } },
    { key: "bridge", name: "吊り橋", flavor: "細い一本道・遮蔽も足場も無い超接近の殴り合い", w: 100, h: 14, base: "plains",
      obstacles: [],
      terrain: [],
      start: { p: { x: 6, y: 7 }, c: { x: 94, y: 7 } } },
    { key: "collapse", name: "崩れゆく遺跡", flavor: "脆い遮蔽だらけ・撃ち込みで崩落多発", w: 115, h: 85, base: "plains",
      obstacles: [{ x: 28, y: 17, w: 8, h: 8 }, { x: 52, y: 50, w: 8, h: 8 }, { x: 78, y: 20, w: 8, h: 8 }, { x: 58, y: 14, w: 7, h: 6 }, { x: 34, y: 58, w: 7, h: 6 }],
      terrain: [{ x: 14, y: 32, w: 12, h: 14, t: "rubble" }, { x: 88, y: 32, w: 12, h: 14, t: "rubble" }],
      start: { p: { x: 8, y: 42 }, c: { x: 107, y: 42 } } },
  ];
